...
urlpatterns = [
    ...
    path('students/id/<str:student_id>/', views.student_by_id, name='student_by_id'),
    ...
    path('students/auto-register/', views.auto_register_students, name='auto_register_students'),
    ...
    path('students/archived/', views.archived_students, name='archived_students'),
    path('students/<int:pk>/restore/', views.restore_student, name='restore_student'),
    path('students/bulk-restore/', views.bulk_restore_students, name='bulk_restore_students'),
    path('students/<int:pk>/purge/', views.purge_archived_student, name='purge_archived_student'),
    path('students/bulk-purge/', views.bulk_purge_archived_students, name='bulk_purge_archived_students'),
    path('students/<int:pk>/discontinue/', views.discontinue_student, name='discontinue_student'),
    ...
    path('exams/<int:pk>/marks/import/template/', views.download_marks_import_template, name='download_marks_import_template'),
    ...
    path('attendance/mark/<str:date_str>/<str:admission_class>/<str:section>/<str:mark_type>/', views.mark_attendance_bulk, name='mark_attendance_bulk'),
    ...
    path('exams/<int:pk>/full-rank-list/', views.full_rank_list, name='full_rank_list'),
    path('exams/<int:pk>/rank-list/', views.full_rank_list, name='rank_list'),
...
path('reports/class-section-summary/', views.class_section_summary, name='class_section_summary'),
    ...
    # Employee detail URL (employee_list and the other employee routes are
    # declared above; this second 'employees/' block only served employee_detail).
