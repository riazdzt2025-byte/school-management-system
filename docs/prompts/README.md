...
| **লোকালি নামানো (git বা git ছাড়া)** | `git checkout main && git pull` (✅ PR #34 merge হয়েছে) · `bash scripts/fetch_prompts.sh main` → `./prompts-bundle/docs/prompts/…` · ZIP: [main archive](https://github.com/riazdzt2025-byte/school-management-system/archive/refs/heads/main.zip) |
