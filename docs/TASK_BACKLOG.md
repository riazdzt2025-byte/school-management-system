...
**2026-09-20 হালনাগাদ:** EX-01 ✅ (PR #39 merge) · EX-02 ✅ (PR #41 — register/roll-order নিয়ম সব output-এ + ordering matrix + ১৫ test — `reports/EX-02.md`)। **এখন খোলা:** EX-03 `SubjectMarkSetting.group` · OF-02 বাকি list views · OF-05 তিন গ্যাপ · OF-06 public progress page + share · OF-07/OF-08 integrity audit · DB-02 `0034`-এর agent-নামের comment · DB-03 SEC-FU-1/SEC-FU-2 · AT-01 per-record correction · AT-02 calendar view · EM-01 assignment · EM-03 closed-period · FN-01 final verification।
