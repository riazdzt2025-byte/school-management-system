...
_Last updated: ২০২৬-০৯-২০ (EX-03 — Group-based Mark Evaluation, ৬৬৮ Django + ১৪ Node, base `7a13e33` = `origin/main`)_
...
**Bengali TL;DR:** 2026-09-19 baseline **৬২৫ Django + ১৪ Node** → EX-01 (PR #39) **৬৩৮** + EX-02 (PR #41) **৬৫৩** + EX-03 (group-aware marks 0044) **৬৬৮ Django + ১৪ Node সব pass**। P0 isolation/validation/voucher/promotion/backup + guardian contact + result analysis + Full Rank List + row gating + roll-order + group marks সব done। বাকি শুধু live Render ops (P0-7/P0-8-live, P1-11-live) + Office gaps (উন্নত Reports, photo continuity) + Attendance calendar (AT-02) + Employee (assignment/leave/closed-period) + OF-02 বাকি ৭টি pagination + DB-02/03 + FN-01। SSC restore করা হয়নি। Accounts full fee engine / guardian portal / online payment **future backlog**-এ।

---

## Status legend

- **Complete** — code + migration (if any) + tests land, verified by `manage.py test students` pass in this session (৬৬৮)
...
**২০২৬-০৯-২০ হালনাগাদ (EX-03-পরবর্তী):** EX-01 ✅ (PR #39) · EX-02 ✅ (PR #41) · **EX-03 ✅** (PR পরবর্তী — `SubjectMarkSetting.group` 0044 + group-aware chain + ১৫ test — `reports/EX-03.md`)। **এখন খোলা:** OF-02 বাকি ৭টি list views · OF-05 তিন গ্যাপ · OF-06 public progress page + share · OF-07/OF-08 integrity audit · DB-02 `0034`-এর agent-নামের comment · DB-03 SEC-FU-1/SEC-FU-2 · AT-01 per-record correction · AT-02 calendar view · EM-01 assignment · EM-03 closed-period · FN-01 final verification।

**⚠️ Note:** এই ফাইলের `44cbcc3`-ভিত্তিক section-গুলোর সংখ্যা (৫৫০/৬০৫ test) ঐতিহাসিক; সর্বশেষ verified সংখ্যা **৬৬৮ Django + ১৪ Node** (EX-03 পর্যন্ত)। `P0-9` entry-র heading (✅ DONE) ও body (Partial) পরস্পরবিরোধী — ২০২৬-০৯-২০-এও README-তে `[ ]` থাকতে পারে; DB-04/FN-01 সেশনে যাচাইযোগ্য।
