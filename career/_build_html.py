...
DOC_META = {
    ...
    '08': ('ট্রাস্ট ও চেয়ারম্যান কৌশল', 'গ্রুপ অব ইনস্টিটিউশন: "এক ছাতার নিচে" ড্যাশবোর্ড, সম্প্রসারণের সিঁড়ি = প্রমোশনের সিঁড়ি, ট্রাস্ট-নির্দিষ্ট ঝুঁকি'),
    '09': ('চেয়ারম্যান প্রপোজাল', 'অধ্যক্ষের মাধ্যমে চেয়ারম্যান বরাবর ৫টি প্রস্তুত চিঠি — কপি-পেস্ট করে জমা দিন'),
}
...
<div class="card" style="border-left:5px solid #0d6efd;background:#f2f7ff">
<h3>আপনার পরিস্থিতিতে — ট্রাস্ট / গ্রুপ অব ইনস্টিটিউশন, সিদ্ধান্ত চেয়ারম্যানের</h3>
<p><strong>আপনার সবচেয়ে বড় হাতিয়ার: মাল্টি-ইনস্টিটিউশন।</strong> রিপোজিটরিতে <code>Institution</code> + <code>InstitutionAccess</code> আছে (৫০টি isolation টেস্টসহ) — অর্থাৎ একাধিক প্রতিষ্ঠান এক ছাতার নিচে। স্থানীয় ভেন্ডরের সিঙ্গেল-স্কুল সফটওয়্যারে এটি প্রায় থাকেই না।</p>
<ol class="big">
<li><a href="সব-একসাথে.html#doc-08"><strong>০৮ · ট্রাস্ট ও চেয়ারম্যান কৌশল</strong></a> — "এক ছাতার নিচে" ড্যাশবোর্ড, আর <em>সম্প্রসারণের সিঁড়িকে প্রমোশনের সিঁড়িতে</em> রূপান্তরের উপায় (১টি → ৩টি → সব প্রতিষ্ঠান)।</li>
<li><a href="সব-একসাথে.html#doc-09"><strong>০৯ · চেয়ারম্যান প্রপোজাল</strong></a> — অধ্যক্ষের মাধ্যমে চেয়ারম্যান বরাবর ৫টি প্রস্তুত চিঠি। <strong>খসড়া ১+২ আজই জমা দিন।</strong></li>
<li>নিয়ম: <strong>কখনও অধ্যক্ষকে বাইপাস করবেন না</strong> — কৃতিত্ব ও ঝুঁকি দুটোই তাঁর রাখুন, আপনি নিরাপদ থাকুন।</li>
</ol></div>
